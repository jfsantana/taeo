...
CREATE TABLE `evaluacion_header` (
  `idHeaderEvaluacion` int NOT NULL AUTO_INCREMENT,
  ...
  `conclucionesRecomendaciones` text,
  `idHeaderEvaluacionAnterior` int DEFAULT NULL,
