...
CREATE TABLE `planificacion_items` (
  ...
  `idPlanificacion` int DEFAULT NULL,
  `idObjetivoItems` int DEFAULT NULL,
  ...
  PRIMARY KEY (`idItems`),
  KEY `idPlanificacionHeader_idx` (`idPlanificacion`),
  CONSTRAINT `idPlanificacionHeader` FOREIGN KEY (`idPlanificacion`) REFERENCES `planificacion_header` (`idPlanificacion`)
