...
class aprendiz extends conexion
{
  ...
  public function getAprendizActivos($idAprendiz) //(revisado)
  {
    ...
    $query = "select * , case when aprendiz.activoAprendiz = 1 Then 'Activo' else 'Desactivado' end estado from " . $this->tabla . " $where ";
    ...
    if (!isset($datos['token'])) {
      ...
      if ($arrayToken) {
        ...
        if (
          ...
          $this->alergiaAprendiz = @$datos['alergiaAprendiz'];
