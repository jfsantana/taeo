...
$URL = $_SESSION['HTTP_ORIGIN'] . "/funciones/wsdl/area";
     //echo $URL;
...
if ((@$rs['status'] == 'OK') or ($_POST['mod']=="2")) {
  ...
  if($_POST['accion']=="Crear"){
   ...
   $url= "onclick=\"enviarParametrosGetsionUpdate2('admin/nivelAreaCreate.php','1','".@$idArea."')\"";
    //$url = "onclick=\"enviarParametrosCRUD('admin/nivelAreaCreate.php')\"";
  }else{
