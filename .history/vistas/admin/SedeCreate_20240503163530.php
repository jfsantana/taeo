...
required_once '../funciones/wsdl/clases/consumoApi.class.php';
          ...
          <div class="card-body">
              <div class="row">
                <div class="col-sm-4">
                  ...
                  <input type="text" class="form-control" required name="rifSede" id="rifSede" placeholder="Rif" value="<?php echo @$rifSede; ?>">
                </div>
                <div class="col-sm-4">
                  <label for="nombreSede">Nombre Sede</label>
                  <input type="text" class="form-control" required name="nombreSede" id="nombreSede" placeholder="Nombre de la Sede" value="<?php echo @$nombreSede; ?>" >
                </div>
                <div class="col-sm-4">
                  <label for="telefonoSede">Telefono Sede</label>
                  <input type="text" class="form-control" required name="telefonoSede" id="telefonoSede" placeholder="Nombre de la Sede" value="<?php echo @$telefonoSede; ?>">
                </div>
                <div class="col-sm-4">
                  <label for="emailSede">Em@il</label>
                  <input type="email" class="form-control" required name="emailSede" id="emailSede" placeholder="Nombre de la Sede" value="<?php echo @$emailSede; ?>">
                </div>
                <div class="col-sm-4">
                  <label for="nombreCliente">Pais</label>
                  <select class="form-control" name="paisSede" id="paisSede" required>
                ...
                <div class="col-sm-4">
                  ...
                  <select class="form-control" name="ciudadSede" id="ciudadSede" required>
                    <option >Seleccione</option>
