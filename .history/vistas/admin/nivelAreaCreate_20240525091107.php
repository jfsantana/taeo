...
if ($_POST['mod'] == 1) {
  ...
  $nombreNivelAreaObjetivo = $arrayUsuario[0]['nombreNivelAreaObjetivo'];
  $descripcionNivelAreaObjetivo = $arrayUsuario[0]['descripcionNivelAreaObjetivo'];
  $idAreaObjetivo = $arrayUsuario[0]['idAreaObjetivo'];
  $activo = $arrayUsuario[0]['activo'];
          ...
          <form>
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-sm-3">
                  <label for="descripcionNivelAreaObjetivo">Apellido</label>
                  <input type="text" class="form-control" name="descripcionNivelAreaObjetivo" id="descripcionNivelAreaObjetivo" placeholder="Apellido(s)" value="<?php echo @$descripcionNivelAreaObjetivo; ?>">
                </div>
