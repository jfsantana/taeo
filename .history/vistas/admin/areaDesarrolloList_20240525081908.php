    ...
    <div class="row">
      <div class="col-lg-12 col-12">
        ...
        <div class="small-box bg-info">
          ...
          <a href="#" onclick="enviarParametrosGetsionCreate('admin/areaCreate.php','1')" class="small-box-footer">Crear &Aacute;rea de Desarrollo <i class="fas fa-arrow-circle-right"></i></a>
        </div>
      </div>
      ...
      <section class="col-lg-12 connectedSortable">
        ...
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">Listado de Aprendiz</h3>
          </div>
          <!-- /.card-header -->
        <div class="card-body">
          <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
              <?php foreach ($arrayAreas as $Clinete) { ?>
                <tr>
