        ...
        <div class="card card-primary">
          ...
          <form>
            <div class="card-body">
              <div class="row">
                <div class="col-sm-4">
                  <label for="nombreCliente">Rif - Codigo Fiscal</label>
                  <input type="text" class="form-control" require name="rifSede" id="rifSede" placeholder="Rif" value="<?php echo @$nombreSede; ?>">
                </div>
                <div class="col-sm-4">
