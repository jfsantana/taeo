...
if ($_POST['mod'] == 1) {
  ...
  $nombreArea = $arrayUsuario[0]['nombreArea'];
  $descripcionArea = $arrayUsuario[0]['descripcionArea'];
  ...
  foreach ($idAreaarrayNivelesAreaActivos  as $representanteByAprendizActivosDato) {
