                        ...
                        <div class="card-body p-0">
                          <div class="col-sm-12">
                              <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                              <?php
                                foreach (@$idAreaarrayNivelesArea  as $area) {   //checked
                              ?>

                                    <tr>
                                      <td><a href="#" onclick="enviarParametrosGetsionUpdate('admin/nivelAreaCreate.php',2,'<?php echo @$area['idarea']; ?>')" class="nav-link ">
                                          <?php echo @$area['nombreNivelAreaObjetivo']; ?></a></td>
                                      <td><?php echo @$area['descripcionNivelAreaObjetivo']; ?></td>
                                      <td><?php echo @$area['activo']; ?></td>
