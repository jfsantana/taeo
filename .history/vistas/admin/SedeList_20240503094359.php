            ...
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                <?php foreach ($arrayCconsultora as $sede) { ?>
                 <tr>
                            <td><a href="#" onclick="enviarParametrosGetsionUpdate('admin/empresaConsultoraCreate.php',2,'<?php echo $sede['idEmpresaConsultora']; ?>')"> <?php echo $sede['nombreEmpresaConsultora']; ?></a></td>
