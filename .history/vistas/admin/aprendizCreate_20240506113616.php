...
<tr>
                            <td><a href="#" onclick="enviarParametrosGetsionUpdate('admin/RepresentanteCreate.php',2,'<?php echo $Representante['idRepresentante']; ?>')" class="nav-link "><?php echo $Representante['apellidoAprendiz'].', '.$Representante['nombreRepresentante'], '.$Clinete['nombreAprendiz']; ?></a></td>
