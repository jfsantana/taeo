            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-sm-3">
                  ...
                  <input type="text" class="form-control" name="emailUsuario" id="emailUsuario" placeholder="Cargo del Personal" value="<?php echo @$emailUsuario; ?>">
                </div>

                <div class="col-sm-3">
                  <label for="nombreCliente">colegioAprendiz</label>
                ...
                <div class="col-sm-3">
                  <label for="nombreCliente">gradoAprendiz</label>
                ...
                <div class="col-sm-3">
                  <label for="nombreCliente">paisAprendiz</label>
                  <input type="text" class="form-control" name="passUsuario" id="passUsuario" placeholder="Clave inicial para  APP" value="<?php echo @$passUsuario; ?>">
                </div>
