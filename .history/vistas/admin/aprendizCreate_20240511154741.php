        ...
        <div class="card card-primary">
          ...
          <form>
            <div class="card-body">
              ...
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Representantes</h3> </div>
                    ...
                    <div class="col-sm-12">
                        ...
                        ?>
                              ...
                              <tr>
                                ...
                                <td>
                                    <a href="#" onclick="enviarParametrosGetsionUpdate('admin/RepresentanteCreate.php',2,'<?php echo $Representante['idRepresentante']; ?>')" class="nav-link ">
                                      <?php echo $Representante['apellidoRepresentante'].', '.$Representante['nombreRepresentante']; ?>
                                    </a>
                                  </td>
                                ...
                                <td ><?php if($Representante['retirarAprendiz']=='true'){echo '<span class="badge bg-success">Si</span>';}else {echo '<span class="badge bg-danger">No</span>';} ?></td>
                              </tr>
                        <?php } ?>
                        </tbody>
                          <tfoot>
