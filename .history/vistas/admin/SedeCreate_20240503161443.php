...
<!-- Main content -->
<form action="../funciones/funcionesGenerales/XM_sede.model.model.php" method="post" name="consultora" id="consultora">
            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-sm-4">
                  ...
                  <input type="mail" class="form-control" require name="emailSede" id="emailSede" placeholder="Nombre de la Sede" value="<?php echo @$emailSede; ?>">
                </div>
                <div class="col-sm-4">
