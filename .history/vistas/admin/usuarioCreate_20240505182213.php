          ...
          <form>
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-sm-2">
                    <label>Sedes</label>
                      <input type="checkbox" id="tarea1" name="tarea1" value="Tarea 1">
                    <label for="tarea1">Tarea 1</label><br>
                     <input type="checkbox" id="tarea2" name="tarea2" value="Tarea 2">
                    <label for="tarea2">Tarea 2</label><br>
                      <input type="checkbox" id="tarea3" name="tarea3" value="Tarea 3">
                    <label for="tarea3">Tarea 3</label><br>
                      <input type="checkbox" id="tarea4" name="tarea4" value="Tarea 4">
