...
echo $URL;
  ...
  $URL1        = "http://" . $_SERVER['HTTP_HOST'] . "/funciones/wsdl/empleadosSede?type=1&idRepresentante=$idRepresentante";//$idRepresentante
  $rs         = API::GET($URL1, $token);
          ...
          <form>
           ...
           //   }
            ...
            <div class="card-footer">
              ...
              <button type="button" class="btn btn-primary" onclick="enviarParametros('admin/represenatnteList.php')">Volver</button>
            </div>
