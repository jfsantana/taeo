                  ...
                  <tbody>
                    ...
                    <?php
                      ...
                      foreach($arrayNodoPadre as $datosNodoPadre)
                      {
                        ...
                        echo ' '.$datosNodoPadre['jerarquia'].' - '.$datosNodoPadre['descripcion'].'( <a href="google.com"><i class="fas fa-edit"></i></a>, <a href="google.com"><i class="fas fa-trash-red "></i></a>)</td></tr>';
