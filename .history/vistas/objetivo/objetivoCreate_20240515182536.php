...
function nivel ($datosNodoPadre, $token){
  $arrayhijos  = hijos($datosNodoPadre['id'], $token);
                            ...
                            <table class="table table-hover">
                              <tbody>
                                ...
                                if(count($arrayhijosN1)<1)
                                {
                                  ...
                                  <tr data-widget="expandable-table" aria-expanded="false">
                                    <td>
                                      <?php echo 'NIVEL 3- SH'.$datosArrayhijos['id'].'-'.$datosArrayhijos['jerarquia'].'-'.$datosArrayhijos['descripcion'];?>
                                    </td>
                                  </tr>
                                  <?php
                                }else
                                {
                                  ...
                                  <tr data-widget="expandable-table" aria-expanded="false">
                                    <td>
                                        ...
                                        <?php echo 'NIVEL 3 - CH'.$datosArrayhijos['id'].'-'.$datosArrayhijos['jerarquia'].'-'.$datosArrayhijos['descripcion'];?>
                                    </td>
                                  </tr>
