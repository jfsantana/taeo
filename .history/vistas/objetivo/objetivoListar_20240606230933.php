          ...
          <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
              <?php foreach ($arrayObjetivo as $objetivo) { ?>
                <tr>
                  <td><?php echo $objetivo['nombreObjetivo']; ?></td>
                  <td><?php echo $objetivo['nombreObjetivo']; ?></td>
                  <td><a href="#" onclick="enviarParametrosGetsionUpdate('objetivo/objetivoCreate.php',2,'<?php echo $objetivo['idObjetivoHeader']; ?>')" class="nav-link "><?php echo $objetivo['nivelObjetivo']; ?></a></td>
