                                                                                                                      ...
                                                                                                                      <table class="table table-hover">
                                                                                                                        <tbody>
                                                                                                                          ...
                                                                                                                          if(count($arrayhijosN1)<1)
                                                                                                                          {
                                                                                                                            ...
                                                                                                                            <tr data-widget="expandable-table" aria-expanded="false">
                                                                                                                              <td>
                                                                                                                                <?php echo 'NIVEL 4- SH'.$datosArrayhijosN4['id'].'-'.$datosArrayhijosN4['jerarquia'].'-'.$datosArrayhijosN4['descripcion'];?>
                                                                                                                              </td>
                                                                                                                            </tr>
                                                                                                                            <?php
                                                                                                                          }else
                                                                                                                          {
                                                                                                                            ...
                                                                                                                            <tr data-widget="expandable-table" aria-expanded="false">
                                                                                                                              <td>
                                                                                                                                  ...
                                                                                                                                  <?php echo 'NIVEL 4 - CH'.$datosArrayhijosN4['id'].'-'.$datosArrayhijosN4['jerarquia'].'-'.$datosArrayhijosN4['descripcion'];?>
                                                                                                                              </td>
                                                                                                                            </tr>
                                                                                                                            <!-- /*Inicio va el codigo para el siguiente nivel*/ -->
                                                                                                                            <?php
