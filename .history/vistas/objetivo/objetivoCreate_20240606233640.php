                ...
                <div class="col-sm-4">
                  ...
                  <select class="form-control" name="nivelObjetivo" id="nivelObjetivo">
                    ...
                    <?php foreach($arrayNivelAreaObjetivo as $NivelAreaObjetivo ){?>
                      <option <?php if ($NivelAreaObjetivo[0]['idNivelAreaObjetivo'] == @$nivelObjetivo) {echo 'selected';} ?> value=<?php echo $NivelAreaObjetivo[0]['idNivelAreaObjetivo']; ?>><?php echo $NivelAreaObjetivo[0]['nombreNivelAreaObjetivo']; ?></option>
                    <?php }?>
