              ...
              <div class="row">
                ...
                <table class="table table-hover">
                  <tbody>
                    ...
                    <?php
                      $idPadre=0;
                      //cambiar este query por los objetivos padres de cada objetivo
                      foreach($arrayItemByHeader as $datoItems) {
                        ...
                        $datoItems['id']; //id del items 13 y 20

                        if($datoItems['id_padre'] == null){
                          $jerarquia=$datoItems['jerarquia'];
                          ...
                          if((strpos($datoItems['jerarquia'], $jerarquia) === 0)){?>
