        ...
        <div class="card card-primary">
          ...
          <form>
                        ...
                        <select class="form-control ml-1 col-sm-2" >
                          <?php
                            foreach($arrayVersiones as $datosVersion){?>
                              <option value="1"><?php echo $datosVersion['versionObjetivo']; ?></option>
                          <?php  } ?>
            ...
            <div class="card-footer">
                    <?php
                      if(($_POST['mod']<>1)&&($flag)){ ?>
                      <button type="button" class="btn btn-warning" onclick="enviarParametrosGetsionUpdate('objetivo/objetivoCreate.php',3,'<?php echo $idObjetivoHeader ; ?>')">Volver a cargar Contenido de la version actual</button>
                      <button type="button" class="btn btn-danger" onclick="enviarParametrosGetsionUpdate('objetivo/objetivoCreate.php',3,'<?php echo $idObjetivoHeader ; ?>')">Crear Nueva version al objetivo</button>
