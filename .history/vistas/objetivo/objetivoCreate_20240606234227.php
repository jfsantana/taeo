              ...
              <div class="col-sm-6">
                  ...
                  <select class="form-control" name="idAreaObjetivo" id="idAreaObjetivo">
                    ...
                    <?php foreach($arrayAreaObjetivo as $areaObjetivo ){?>
                      <option <?php if ($NivelAreaObjetivo['idNivelAreaObjetivo'] == @$idAreaObjetivo) {echo 'selected';} ?> value=<?php echo $NivelAreaObjetivo['idNivelAreaObjetivo']; ?>><?php echo $NivelAreaObjetivo['nombreNivelAreaObjetivo']; ?></option>
                    <?php }?>
                  </select>
                </div>
