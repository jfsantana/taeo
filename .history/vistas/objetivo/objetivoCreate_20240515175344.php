                                                ...
                                                <?php
                                                 ...
                                                 <tr class="expandable-body">
                                                  <td>
                                                          ...
                                                          <td>
                                                          <?php echo 'NIVEL 2 (SIN HIJO)-'.$datosArrayhijos['id'].'-'.$datosArrayhijos['jerarquia'].'-'.$datosArrayhijos['descripcion'];?>
                                                          </td>
                                                      ...
                                                      <tbody>
                                                        <tr data-widget="expandable-table" aria-expanded="false">
                                                          ...
                                                          <td>
                                                              ...
                                                              <?php echo 'NIVEL 2 (CON HIJO)-'.$datosArrayhijos['id'].'-'.$datosArrayhijos['jerarquia'].'-'.$datosArrayhijos['descripcion'];?>
                                                          </td>
                                                        </tr>
                                                        <tr class="expandable-body">
                                                          <td>
                                                            <div class="p-0">
                                                              <table class="table table-hover">
                                                                ...
                                                                $datoHijosN2  = hijos($datosArrayhijos['id'], $token);
                                                                /****INICIO NIVEL 3****/
                                                                foreach($datoHijosN2 as $datosArrayhijosN2)
                                                                {

                                                                  $datoHijosN3  = hijos($datosArrayhijosN2['id'], $token);
                                                                  if (count($datoHijosN3)<1)
                                                                  {
                                                                    echo '<tr><td>NIVEL 3 (SIN HIJO)-';
                                                                    echo $datosArrayhijosN2['id'].'-'.$datosArrayhijosN2['jerarquia'].'-'.$datosArrayhijosN2['descripcion'];
                                                                    echo '<td></tr>';
                                                                        ...
                                                                        <tbody>
                                                                          <tr data-widget="expandable-table"  aria-expanded="false">
                                                                            <td>
                                                                              ...
                                                                              <?php echo 'NIVEL 3 (con HIJO)-'.$datosArrayhijosN2['id'].'-'.$datosArrayhijosN2['jerarquia'].'-'.$datosArrayhijos['descripcion'];?>
                                                                            </td>
                                                                          </tr>
                                                                          <tr class="expandable-body">
                                                                            <td>
                                                                              <div class="p-0">
                                                                                <table class="table table-hover">
                                                                                  <tbody>
                                                                                    ...
                                                                                    <tr><td>
                                                                                      <?php
                                                                                        echo '<tr><td>-'.$datosArrayhijosN2['id'];
                                                                                        print_r($datosArrayhijosN2);
                                                                                        echo '<td></tr>';?>
                                                                                      <td>
                                                                                    </tr>';
                                                                                  </tbody>
