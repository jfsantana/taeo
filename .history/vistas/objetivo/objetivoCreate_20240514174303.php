...
function recorrerTabla($nodoPadre, $nivel = 0) {
  // Obtener los nodos hijos del nodo padre
  $query = "SELECT * FROM objetivo WHERE nodoPadre = $nodoPadre";
...
// Llamar a la función con el nodo raíz
recorrerTabla(1);
                      ...
                      foreach($arrayNodoPadre as $datosNodoPadre) {
                        ...
                        if(!$banderaNodoPadre){
                          ...
                          echo'<tr data-widget="expandable-table" aria-expanded="false">
                                  <td>
                                    <i class="expandable-table-caret fas fa-caret-right fa-fw"></i>'.$datosNodoPadre['jerarquia'].'-'.$datosNodoPadre['descripcion'].'
                                  </td>
                                </tr>';
                                $banderaNodoPadre=true;
                        }else{
                          //YA VENGO CON EL PRIMER NODO PADRE
                          $datosNodoPadre;
                          //necesito conocer el nivel mas amplio para los hijos de los nodos padres , ejemplo 5
                          $nivelMax=1;
