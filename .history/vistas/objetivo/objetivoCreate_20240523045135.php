            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-sm-3">
                  ...
                  <input type="text" class="form-control" name="observacionObjetivo" id="observacionObjetivo" placeholder="Observacion" required value="<?php echo @$observacionObjetivo; ?>">
                </div>
