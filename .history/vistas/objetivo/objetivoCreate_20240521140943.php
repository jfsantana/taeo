                  ...
                  <tbody>
                    ...
                    <?php
                      ...
                      foreach($arrayNodoPadre as $datosNodoPadre)
                      {
                        ...
                        $variable = array(['padre']=>$datosNodoPadre['id'], ['hijo']=>@$idObjetivoHeader);
                        $parameter=json_encode($variable);
                        echo $parameter;
                        ...
                        echo ' '.$datosNodoPadre['jerarquia'].' - '.$datosNodoPadre['descripcion'].'
                            (
                              <a href="#"
                              onclick="enviarParametrosGetsionUpdate(\'objetivo/itemCreate.php\',2,'.$parameter. ')"
