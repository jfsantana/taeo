                  ...
                  <tbody>
                    ...
                    <?php
                      ...
                      foreach($arrayNodoPadre as $datosNodoPadre)
                      {
                        ...
                        echo ' '.$datosNodoPadre['jerarquia'].' - '.$datosNodoPadre['descripcion'].'( <a href="google.com"><i class="fas fa-edit fa-fw"></i></a>, <a href="google.com"><i class="fas fa-del fa-fw"></i></a>)</td></tr>';
