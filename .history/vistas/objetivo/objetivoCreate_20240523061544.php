            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-sm-12">
                    ...
                    <textarea id="summernote" name="observacionObjetivo" max="20" maxlength="20" row="20" rows="20" style="max-height: 200px; overflow-y: auto;"><?php echo @$observacionObjetivo; ?></textarea>
                </div>
