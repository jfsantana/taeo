...
if ($_POST['mod'] == 1) {
  ...
  $nombreObjetivo = $arrayUsuario[0]['nombreObjetivo'];
  $versionObjetivo = $arrayUsuario[0]['versionObjetivo'];
            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-sm-3">
                  ...
                  <input type="text" class="form-control" readonly name="fechaCreacion" id="fechaCreacion" placeholder="fechaCreacion" value="<?php echo date('Y-m-d',@$fechaCreacion); ?>">
                </div>
