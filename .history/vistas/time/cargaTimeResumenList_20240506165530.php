    ...
    <div class="row">
      <div class="col-lg-6 col-12">
        ...
        <div class="small-box bg-warning">
          ...
          <!-- <a href="#" onclick="enviarParametrosGetsionUpdate('time/facturaCreate.php','<?php echo $idAux; ?>','<?php echo $_SESSION['corte']; ?>')" class="small-box-footer"> -->
          Ver Planificaicones <i class="fas fa-arrow-circle-right"></i>
        <!-- </a> -->
        </div>
      </div>
      <div class="col-lg-6 col-12">
