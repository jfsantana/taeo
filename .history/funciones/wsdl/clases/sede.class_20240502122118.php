    ...
    if (!isset($datos['token'])) {
      ...
      if ($arrayToken) {
        ...
        if (
          ...
          $this->nombreSede =@$datos['nombreEmpresaConsultora'];
          $this->paisSede =@$datos['nombreEmpresaConsultora'];
          $this->ciudadSede =@$datos['nombreEmpresaConsultora'];
          $this->direccionSede =@$datos['nombreEmpresaConsultora'];
          $this->rifSede =@$datos['nombreEmpresaConsultora'];
          $this->telefonoSede =@$datos['nombreEmpresaConsultora'];
          $this->emailSede =@$datos['nombreEmpresaConsultora'];
          $this->activo = @$datos['nombreEmpresaConsultora'];
          $this->fechaCreacion = date('Y-m-d');
          $this->creador = @$datos['nombreEmpresaConsultora'];
