      ...
      if ($arrayToken) {
        ...
        if (
          ...
          if($datos['mod']==1){//creacion del header y los items
            ...
            $URL        = "http://" . $_SERVER['HTTP_HOST'] . "/funciones/wsdl/objetivoItem";
            $rs         = API::PUT($URL,$TOKEN,$ARRAY);
            $updateItems  = API::JSON_TO_ARRAY($rs);



          echo $URL;
            print("<pre>".print_r(json_encode($updateItems),true)."</pre>"); die;
