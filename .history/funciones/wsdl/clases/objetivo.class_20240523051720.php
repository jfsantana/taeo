...
class objetivo extends conexion
{
  ...
  public function getObjetivosHeadere($idObjetivoHeader) //()
  {
    ...
    $query = "select *, case when objetivo_header.activo = 1 Then 'Activo' else 'Bloqueado' end estado,  SUBSTRING_INDEX(campo_texto, '\n', 10) as resumen from " . $this->tablaHeader . " $where ";
    //echo   $query; die;
