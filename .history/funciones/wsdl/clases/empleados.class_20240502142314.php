...
class empleados extends conexion
{
  ...
  private function Update()
  {
    $query = 'update ' . $this->tabla . "
                      ...
                      $this->passUsuario = @$datos[''];
                      $this->rolUsuario = @$datos[''];
                      $this->nombreUsuario = @$datos[''];
                      $this->apellidoUsuario = @$datos[''];
                      $this->cargoUsuario = @$datos[''];
                      $this->cedulaUsuario = @$datos[''];
                      $this->emailUsuario = @$datos[''];
                      $this->telefonoUsuario = @$datos[''];
                      $this->TelefonoEmergencia = @$datos[''];
                      $this->activoUsuario = @$datos[''];
                      $this->fechaCreacion = date('Y-m-d');
                      $this->creadoPor = @$_SESSION['usuario'];
