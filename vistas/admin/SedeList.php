...
$URL        = $_SESSION['HTTP_ORIGIN'] . "/funciones/wsdl/sede?type=1";
    ...
    <div class="row">
      <div class="col-lg-12 col-12">
        ...
        <div class="small-box bg-danger">
          ...
          <a href="#" onclick="enviarParametrosGetsionCreate('admin/SedeCreate.php','1')" class="small-box-footer">Crear Sede <i class="fas fa-arrow-circle-right"></i></a>
        </div>
      </div>
            ...
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                <?php foreach ($arrayCconsultora as $sede) { ?>
                 <tr>
                            <td><a href="#" onclick="enviarParametrosGetsionUpdate('admin/SedeCreate.php',2,'<?php echo $sede['idSede']; ?>')"> <?php echo $sede['nombreSede']; ?></a></td>
