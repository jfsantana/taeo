...
if ($_POST['mod'] == 1) {
  ...
  $fechaNacimiento = $arrayUsuario[0]['fechaNacimiento'];
  ...
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        ...
        <h4 class="m-0">(Mediador (a)/Coordinadores)</h4>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container -fluid -->
</div>
          ...
          <form>
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-sm-3">
                  ...
                  <input type="email" class="form-control" name="emailUsuario" id="emailUsuario" placeholder="Email" value="<?php echo @$emailUsuario; ?>">
                </div>

                <div class="col-sm-3">
                  <label for="nombreCliente">Teléfono Personal</label>
                ...
                <div class="col-sm-3">
                  <label for="nombreCliente">Teléfono Emergencia</label>
                  <input type="text" class="form-control" name="TelefonoEmergencia" id="TelefonoEmergencia" placeholder="Telefono de Emergencia" value="<?php echo @$TelefonoEmergencia; ?>">
                </div>

                <div class="col-sm-2">
                  <label>Fecha de Nacimiento:</label>
                  <div class="input-group date" id="reservationdate" data-target-input="nearest">
                    <input type="text" class="form-control datetimepicker-input" data-target="#reservationdate" name="fechaNacimiento" value="<?php echo @$fechaNacimiento; ?>">
           ...
           //   }
            ...
            <div class="card-footer">
              ...
              <button type="button" class="btn btn-primary" onclick="enviarParametros('admin/usuarioList.php')">Volver</button>
            </div>
