...
<head>
  ...
  <style>
    .login-page {
      /* background: url('./dist/img/foot_Image.jpg') repeat-x; 13336768 fondo pantalla*/
      ...
      <div class="card-body">
        ...
        $token='';
          ...
          <form name="login" id="login" action="funciones/funcionesGenerales/XM_validarusu.php" method="POST">
            ...
            <div class="input-group mb-3">
              <input name="password" type="password" class="form-control" required placeholder="Clave">
              <div class="input-group-append">
                <div class="input-group-text">
