<div class="col-sm-12">
    <label for="conclucionesRecomendaciones" class="d-block text-center text-white py-1" style="font-size: 0.8rem; background-color: #00B9F1;"><strong>DATOS DEL APRENDIZ</strong></label>
</div>
