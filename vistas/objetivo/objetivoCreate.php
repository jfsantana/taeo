                ...
                <table class="table table-hover">
                  <tbody>
                    ...
                    <?php
                      ...
                      $nivelMax=count($arrayNodoPadre);  //numero de nodos padres del objetivo
                      echo $nivelMax;
                      ...
                      foreach($arrayNodoPadre as $datosNodoPadre) {
                        ...
                        $URL        = "http://" . $_SERVER['HTTP_HOST'] . "/funciones/wsdl/objetivo?type=3&id_padre=".$datosNodoPadre['id_padre'];
                        $rs         = API::GET($URL, $token);
